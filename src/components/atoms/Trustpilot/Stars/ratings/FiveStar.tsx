...
export const FiveStar = () => (
  <g id="Trustpilot_ratings_5star-RGB" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
    <g>
      <g>
        ...
        <rect id="Rectangle-path5" fill="#00B67A" fillRule="nonzero" x="416" y="0" width="96" height="96"></rect>
        <path
