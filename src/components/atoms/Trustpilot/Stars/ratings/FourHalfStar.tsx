...
export const FourHalfStar = () => (
  <g id="Trustpilot_ratings_4halfstar-RGB" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
    <g>
      <g>
        <rect id="Rectangle-path1" fill="#00B67A" fillRule="nonzero" x="0" y="0" width="96" height="96"></rect>
        <rect id="Rectangle-path2" fill="#00B67A" fillRule="nonzero" x="104" y="0" width="96" height="96"></rect>
        <rect id="Rectangle-path3" fill="#00B67A" fillRule="nonzero" x="208" y="0" width="96" height="96"></rect>
        <rect id="Rectangle-path4" fill="#00B67A" fillRule="nonzero" x="312" y="0" width="96" height="96"></rect>
        <g id="Half" transform="translate(416.000000, 0.000000)" fillRule="nonzero">
          <rect id="Rectangle-path5" fill="#DCDCE6" x="48" y="0" width="48" height="96"></rect>
          <rect id="Rectangle-path6" fill="#00B67A" x="0" y="0" width="48" height="96"></rect>
        </g>
        <path
