...
- 8176778: Comment why the smart saver link url was changed

## 5.71.9

### Patch Changes

- c87e830: smart saver footer link update
...
- 70751f5: Added new link to the footer

## 5.71.6

### Patch Changes

- 7089b76: Make theme navbar link open in a new tab

## 5.71.5

### Patch Changes

- 0c839de: add cobranded to 500
...
- 5552298: zopa footer to accept co branding
...
- 0deeaf5: Utilise react-18 for the tooling and types

## 5.69.2

### Patch Changes

- 57b82bd: Pass shouldApplyClassName to FlexContainer used in ProductTemplate
...
- **fonts:** You won't be able to see Alverate font anymore in the components. Default
  ...
  typographic rules.
- **typography:** You won't be able to import and use anymore `<Header1 />`, `<Header2 />`, `<Header3 />`, `<Header4 />`, `<Title1 />`, `<Title2 />`, `<Title3 />`, `<Title4 />`, `<Caption />`,
...
- **checkbox:** make it work in ie11 ([1e07075](https://github.com/zopaUK/react-components/commit/1e07075))
...
- **navdropdown:** fix types ([bdfc1c5](https://github.com/zopaUK/react-components/commit/bdfc1c5))
- **navdropdown:** handle click outside and escape key press ([e6e06ac](https://github.com/zopaUK/react-components/commit/e6e06ac))
- **navdropdown:** pass down menu item refs ([1a822ab](https://github.com/zopaUK/react-components/commit/1a822ab))

### Features

- **dropdown:** handle keydown ([668fd82](https://github.com/zopaUK/react-components/commit/668fd82))
- **navbar:** create navbar component ([35d3f63](https://github.com/zopaUK/react-components/commit/35d3f63))
- **navdropdown:** create navdropdown component ([36230ca](https://github.com/zopaUK/react-components/commit/36230ca))
- **navdropdown:** create navdropdown component ([f06b47b](https://github.com/zopaUK/react-components/commit/f06b47b))
- **navlink:** create navlink component ([6d46820](https://github.com/zopaUK/react-components/commit/6d46820))

# [5.5.0](https://github.com/zopaUK/react-components/compare/v5.4.4...v5.5.0) (2019-02-04)

### Features

- **text:** create flexible text component ([42c7f96](https://github.com/zopaUK/react-components/commit/42c7f96))

## [5.4.4](https://github.com/zopaUK/react-components/compare/v5.4.3...v5.4.4) (2019-02-01)

### Bug Fixes

- **zopafooter:** ignore zopafooter subcomponents in docs ([d14d4ab](https://github.com/zopaUK/react-components/commit/d14d4ab))

## [5.4.3](https://github.com/zopaUK/react-components/compare/v5.4.2...v5.4.3) (2019-01-31)

### Bug Fixes

- **icons:** add role="img" to social media icons ([6f4f752](https://github.com/zopaUK/react-components/commit/6f4f752))

## [5.4.2](https://github.com/zopaUK/react-components/compare/v5.4.1...v5.4.2) (2019-01-23)

### Bug Fixes

- **types:** remove deprecated types SFC and StatelessFunctional ([9c776a6](https://github.com/zopaUK/react-components/commit/9c776a6))

## [5.4.1](https://github.com/zopaUK/react-components/compare/v5.4.0...v5.4.1) (2019-01-15)

### Bug Fixes

- **menuitem:** center chevron element ([ca01a7d](https://github.com/zopaUK/react-components/commit/ca01a7d))

# [5.4.0](https://github.com/zopaUK/react-components/compare/v5.3.0...v5.4.0) (2019-01-15)

### Bug Fixes

- **navmenu:** menu item hover ([e10688f](https://github.com/zopaUK/react-components/commit/e10688f))

### Features

- **navmenu:** implement chevron on menuitem ([96ed3d2](https://github.com/zopaUK/react-components/commit/96ed3d2))

# [5.3.0](https://github.com/zopaUK/react-components/compare/v5.2.1...v5.3.0) (2019-01-15)

### Bug Fixes

- update snapshots ([795d0fa](https://github.com/zopaUK/react-components/commit/795d0fa))

### Features

- add a hidden value to column props ([cba93b9](https://github.com/zopaUK/react-components/commit/cba93b9))

## [5.2.1](https://github.com/zopaUK/react-components/compare/v5.2.0...v5.2.1) (2019-01-10)

### Bug Fixes

- **radio:** add disabled and error designs ([2a28773](https://github.com/zopaUK/react-components/commit/2a28773))

# [5.2.0](https://github.com/zopaUK/react-components/compare/v5.1.14...v5.2.0) (2019-01-08)

### Features

- **accordion:** add accordion component ([e54527e](https://github.com/zopaUK/react-components/commit/e54527e))

## [5.1.14](https://github.com/zopaUK/react-components/compare/v5.1.13...v5.1.14) (2019-01-07)

### Bug Fixes

- **dependencies:** fix some components missing in the style-guide ([76779e7](https://github.com/zopaUK/react-components/commit/76779e7))

## [5.1.13](https://github.com/zopaUK/react-components/compare/v5.1.12...v5.1.13) (2018-12-20)

### Bug Fixes

- **config:** generate types again ([c7a4381](https://github.com/zopaUK/react-components/commit/c7a4381))

## [5.1.12](https://github.com/zopaUK/react-components/compare/v5.1.11...v5.1.12) (2018-12-20)

### Bug Fixes

- **config:** migrate to create-react-app config ([1ffa446](https://github.com/zopaUK/react-components/commit/1ffa446))

## [5.1.11](https://github.com/zopaUK/react-components/compare/v5.1.10...v5.1.11) (2018-12-19)

### Bug Fixes

- **release:** fix add label ([6b3ccaa](https://github.com/zopaUK/react-components/commit/6b3ccaa))

## [5.1.10](https://github.com/zopaUK/react-components/compare/v5.1.9...v5.1.10) (2018-12-19)

### Bug Fixes

- **release:** testing CI ([674fb43](https://github.com/zopaUK/react-components/commit/674fb43))

## [5.1.9](https://github.com/zopaUK/react-components/compare/v5.1.8...v5.1.9) (2018-12-19)

### Bug Fixes

- **release:** remove typescript definitions tarball ([a645e64](https://github.com/zopaUK/react-components/commit/a645e64))

## [5.1.8](https://github.com/zopaUK/react-components/compare/v5.1.7...v5.1.8) (2018-12-19)

### Bug Fixes

- **release:** disable CI verification ([6901ad9](https://github.com/zopaUK/react-components/commit/6901ad9))
- **release:** disable debug and dry-run mode ([2d63d54](https://github.com/zopaUK/react-components/commit/2d63d54))
- **release:** disable dryRun mode ([a52b9d9](https://github.com/zopaUK/react-components/commit/a52b9d9))
